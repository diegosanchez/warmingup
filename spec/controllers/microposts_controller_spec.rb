...
RSpec.describe MicropostsController, :type => :controller do
  ...
  let!(:author) { User.create! name: 'me', email: 'me@test.com' }

  # This should return the minimal set of attributes required to create a valid
  # Micropost. As you add validations to Micropost, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) {
    { :user_id => author.to_param, :content => 'this is my post' }
  }
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) {
        { :user_id => author.to_param, :content => 'new post content' }
      }
      ...
      it "updates the requested micropost" do
        ...
        micropost.reload
        expect(micropost.content).to eql('new post content')
      end
